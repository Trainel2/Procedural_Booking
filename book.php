                    ...
                    <div class="row">
                        <div class="col-md-12 panel-info">
                            ...
                            <div class="content-box-large box-with-header">
                                ...
                                <br>
                                <?php
                                if ($s_login_status === 'admin') {
                                    echo "<button id='remove' class='btn btn-danger' disabled><i class='glyphicon glyphicon-remove'></i> ลบข้อมูล</button>";
                                }
                                ?>

                                <!-- table -->
                                <table id="table" data-toggle="table" data-url="book_data.php"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php
                                            if ($s_login_status === 'admin') {
                                                echo "<th data-formatter='operateFormatter1' data-events='operateEvents1' data-align = 'center'>แก้ไข</th>";
                                            }
                                            ?>
